...
### Output tables (schema contract v0.8.2)
...
- Current schema contract: v0.8.2 (CGMES 3.0+ only)
...
- raptrix-cim-arrow/src/schema.rs: v0.8.2 table schemas, metadata constants, and schema registry helpers
